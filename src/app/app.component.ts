...
this.vue=true
 ...
 /* OnChanger( index: any){
this.nouveau.modif=this.modif
this.nouveau.Mark=this.Mark
this.nouveau.Descrip=this.Descrip
this.nouveau.Prixx=this.Prixx

//this.HommeHabit.push(...this.nouveau)
if (index !== -1) {
  // Utilisation de la méthode splice pour supprimer l'élément du tableau
  this.HommeHabit.splice(index, 1);
